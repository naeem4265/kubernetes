...
import (
	...
	"github.com/ishtiaqhimel/crd-controller/pkg/client/clientset/versioned/scheme"
...
func (c *CrdV1Client) Ishtiaqs(namespace string) IshtiaqInterface {
	return newIshtiaqs(c, namespace)
}
